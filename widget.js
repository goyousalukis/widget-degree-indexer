...
cpdefine("inline:net-mydomain-widget-degreeindexer", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        ...
        drawCircle: function(majDiv, minDiv) {
            ...
            ctx.arc(200,200,circleRadius,-Math.PI,Math.PI);
            ctx.stroke();
            ctx.lineWidth = 1;
        ...
        onHelloBtnClick: function(evt) {
            ...
            var currentPosition = document.getElementById("currentPos").value;
            var temp1;
            ...
            document.getElementById("currentPos").value = temp1;
